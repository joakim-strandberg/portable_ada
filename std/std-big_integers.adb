...
with Std.Big_Integers.Check;
--  with Ada.Text_IO;
with Ada.Unchecked_Deallocation;

with Interfaces;

package body Std.Big_Integers is

   subtype Huge_int is Zzz.Big_Integers.Huge_int;
   ...
   function Shift_Left
     (Value  : Block_type;
      Amount : Natural) return Block_type renames Zzz.Big_Integers.Shift_Left;

   function Shift_Right
     (Value  : Block_type;
      Amount : Natural) return Block_type renames Zzz.Big_Integers.Shift_Right;

   function Shift_Left
     (
      Value  : Long_Block_type;
      Amount : Natural
     ) return Long_Block_type renames Zzz.Big_Integers.Shift_Left;

   function Shift_Right
     (
      Value  : Long_Block_type;
      Amount : Natural
     ) return Long_Block_type renames Zzz.Big_Integers.Shift_Right;
   ...
   begin
      ...
      if abss <= Long_Block_type (maxblock) then
         ...
         if reste <= Long_Block_type (maxblock) then
            ...
            if
              Shift_Right (reste, Block_type_bits) > Long_Block_type (maxblock)
            then
