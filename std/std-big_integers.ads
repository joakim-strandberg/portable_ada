...
with Zzz.Big_Integers;
pragma Elaborate_All (Zzz.Big_Integers);

package Std.Big_Integers is
...
private
   ...
   subtype Long_Block_type is Zzz.Big_Integers.Long_Block_type;
   ...
   subtype Block_type is Zzz.Big_Integers.Block_type;
