...
package Std.Bounded_Vectors is
   ...
   function Last_Element_Reference (This : access Vector) return Element_Ptr;
   ...
   --    (This : access Vector) return Constant_Elements_Ptr;

private

   type Vector (Capacity : Index) is limited record
      Items      : Elements_Array (1 .. Capacity);
