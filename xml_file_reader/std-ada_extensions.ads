...
package Std.Ada_Extensions is
   ...
   function "=" (Left, Right : Octet_Array) return Boolean renames
     Ada.Streams."=";

   function "&" (Left, Right : Octet_Array) return Octet_Array renames
     Ada.Streams."&";
   ...
   type Subprogram_Error_Code is limited record
      Code_1 : Int32;
      Code_2 : Int32;
   end record;
   ...
   type Subprogram_Call_Result is limited private;

   procedure Initialize
     (This   : in out Subprogram_Call_Result;
      Code_1 : Int32;
      Code_2 : Int32);

   function Has_Failed (This : Subprogram_Call_Result) return Boolean;

   function Is_Success (This : Subprogram_Call_Result) return Boolean;

   function Message (This : Subprogram_Call_Result) return String;

   type Extended_Subprogram_Call_Result is limited private;

   procedure Initialize
     (This   : in out Extended_Subprogram_Call_Result;
      Code_1 : Int32;
      Code_2 : Int32);

   function Has_Failed (This : Extended_Subprogram_Call_Result) return Boolean;

   function Message (This : Extended_Subprogram_Call_Result) return String;
...
private
   ...
   type Subprogram_Call_Result is limited record
      Codes         : Subprogram_Error_Code;
   ...
   type Extended_Subprogram_Call_Result is limited record
      Codes     : Subprogram_Error_Code;
      My_Status : Parsing_Status := Success_And_Continue;
   end record;
